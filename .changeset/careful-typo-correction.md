...
`precise` (0.003 × 0.01 = 0.00003%/char) remains the right preset for "near-zero typo rate." `distracted` (0.06 × 0.30 = 1.8%/char) is unchanged and remains the right preset for "realistic noisy typing."
